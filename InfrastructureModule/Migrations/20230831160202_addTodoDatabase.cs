    ...
    public partial class addTodoDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SettingEntity", x => x.SettingId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Todos_AspNetUsers_CompletedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SharedTodos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TodoHistories_AspNetUsers_CommentedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TodoId = table.Column<int>(type: "int", nullable: false),
                    SetById = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RemainderOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TodoRemainders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TodoRemainders_AspNetUsers_SetById",
                        column: x => x.SetById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TodoRemainders_Todos_TodoId",
                        column: x => x.TodoId,
                        principalTable: "Todos",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedTodos_UserId",
                table: "SharedTodos",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TodoHistories_CommentedByUserId",
                table: "TodoHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TodoRemainders_SetById",
                table: "TodoRemainders",
                column: "SetById");

            migrationBuilder.CreateIndex(
                name: "IX_TodoRemainders_TodoId",
                table: "TodoRemainders",
                column: "TodoId");

            migrationBuilder.CreateIndex(
                name: "IX_Todos_CompletedBy",
                table: "Todos",
                column: "CompletedBy");
